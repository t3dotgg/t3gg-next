...
Remember the old skeuomorphic design of iOS past? No? Let's explore.

The compass is a great start point. Wood grain, gold border, paper-like body with a soft light shining in an uneven pattern.

<img
  src="/images/ios-7/ios-6-compass.png"
  alt={"iOS 6 vs iOS 7 compass - image provided by RedmondPie.com"}
  style={{ height: "20rem" }}
/>
