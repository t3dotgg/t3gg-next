...
import ttfmweb from "ttfmweb";

<a href="https://beta.tt.fm">
  <Image placeholder="blur" src={ttfmweb} />
</a>
...
import ttfmmobile from "ttfmmobile";

<a
  href="https://beta.tt.fm"
  style={{ width: 300, display: "flex", alignItems: "center" }}
>
  <Image placeholder="blur" src={ttfmmobile} />
</a>
...
<a href="https://twitch.tv/moderator">
  <Image placeholder="blur" src={mod} />
</a>
...
<a href="https://twitch.tv/studio">
  <Image placeholder="blur" src={studio} />
</a>

_April 2020 - January 2021_
...
<a href="https://dashboard.twitch.tv/">
  <Image placeholder="blur" src={manager} />
</a>
...
<a href="https://help.twitch.tv/s/article/channel-points-guide?language=en_US">
  <Image placeholder="blur" src={copo} />
</a>
...
<a href="https://doge.t3.gg">
  <Image placeholder="blur" src={doge} />
</a>
...
<a href="https://chrome.google.com/webstore/detail/chrometana-redirect-bing/kaicbfmipfpfpjmlbpejaoaflfdnabnc">
  <Image placeholder="blur" src={chrome} />
</a>
...
import insquare from "insquare";

<a href="https://github.com/theobr/insquare">
  <Image placeholder="blur" src={insquare} />
</a>

Remember Pebble? I was a big fan of those early smartwatches. I developed [InSquare](https://github.com/theobr/insquare), a minimal watchface for the Pebble and Pebble Steel.

This watchface still gets a surprising number of downloads from Pebble holdouts. You can [get it on Rebble.io here](https://apps.rebble.io/en_US/application/54d9664963eb418376000045?query=InSquare&section=watchfaces)

### Personal Site and Blog

<a href="https://t3.gg">
  <img src="/images/projects/V1.svg" />
</a>
...
I was a mentor for [RCOS](https://rcos.io/) starting early in my time at RPI. I was disappointed by how dated most of RPI's coursework was, and how it abstained from teaching important technologies like git, linux, and even basic javascript. I used RCOS to learn and mentor others in modern, open source technologies, helping hundreds of students contribute to dozens of open source projects.
